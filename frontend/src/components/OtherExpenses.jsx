...
const OtherExpenses = () => {
  ...
  const fetchExpenses = async () => {
    ...
    try {
      const res = await axios.get("https://goldenpluscafeandrestaurantapp.onrender.com/api/auth/expense/other", {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://goldenpluscafeandrestaurantapp.onrender.com/api/auth/expense/other/${editingExpense}`,
        editData,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
