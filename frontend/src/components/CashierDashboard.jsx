  ...
  const fetchData = async (dateStr) => {
    ...
    try {
      const [summaryRes, ordersRes] = await Promise.all([
        axios.get("https://goldenpluscafeandrestaurantapp.onrender.com/api/auth/admin/summary", {
          headers: { Authorization: `Bearer ${token}` },
          params: { startDate, endDate }
        }),
        axios.get("https://goldenpluscafeandrestaurantapp.onrender.com/api/auth/orders", {
          headers: { Authorization: `Bearer ${token}` },
          params: { startDate, endDate }
        })
      ]);
